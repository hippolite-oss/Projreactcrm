...
import { 
  ...
  Check, MessageSquare, ArrowRight, Loader2, AlertCircle
} from 'lucide-react';
...
const NouvelleCommande = () => {
  const { ajouterNouvelleCommande } = useNotifications();
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('📤 NouvelleCommande - Envoi de la commande:', formData);
    ...
    try {
      ...
      if (response.data.success || response.data) {
        const nouvelleCommande = response.data.data || response.data;
        console.log('✅ Commande créée avec succès:', nouvelleCommande);
        
        setIsSubmitted(true);
        
        // Notifier le système de la nouvelle commande
        ajouterNouvelleCommande(nouvelleCommande);
